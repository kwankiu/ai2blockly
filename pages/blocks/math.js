...
/*TODO MERGE INTO math_arthimetic
...
Blockly.Blocks['math_convert_number'] = {
  init: function() {
    this.appendValueInput("NAME")
        .setCheck(["Number", "String"])
        .appendField(new Blockly.FieldDropdown([["denary to hexadecimal","DEC_TO_HEX"], ["hexadecimal to denary","HEX_TO_DEC"], ["denary to binary","DEC_TO_BIN"], ["binary to denary","BIN_TO_DEC"]]), "OP");
    this.setOutput(true, null);
    this.setColour(210);
 this.setTooltip("");
 this.setHelpUrl("");
